...
import it.pagopa.cruscotto.ingestion.service.BatchMetadataCleanupService;
...
public class QuartzBatchMetadataCleanupJob extends QuartzJobBean {

    @Autowired
    private BatchMetadataCleanupService batchMetadataCleanupService;
    ...
    protected void executeInternal(JobExecutionContext context) throws JobExecutionException {
        ...
        String entityName = "BATCH_METADATA_PURGE";
        ...
        try {
            ...
            trackedJobExecutor.runTracked(entityName, "quartz-" + entityName, runId,
                    () -> batchMetadataCleanupService.cleanup(runId));
        } finally {
